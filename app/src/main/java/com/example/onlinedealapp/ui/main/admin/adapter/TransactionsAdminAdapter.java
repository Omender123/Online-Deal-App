...
import com.example.onlinedealapp.ui.main.admin.transactions.DetailTransactionsAdminFragment;
...
public class TransactionsAdminAdapter extends RecyclerView.Adapter<TransactionsAdminAdapter.ViewHolder>  {
    ...
    public TransactionsAdminAdapter(Context context, List<TransactionsModel> transactionsModelList) {
    ...
    @NonNull
    @Override
    public TransactionsAdminAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view  = LayoutInflater.from(context).inflate(R.layout.list_transactions, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull TransactionsAdminAdapter.ViewHolder holder, int position) {
