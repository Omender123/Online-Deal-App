...
import com.example.onlinedealapp.databinding.FragmentAdminUpdateProductBinding;
...
public class AdminUpdateProductFragment extends Fragment {
    ...
    private void getDetailProduct(){
        showProgressBar("Loading", "Loading products...", true);
