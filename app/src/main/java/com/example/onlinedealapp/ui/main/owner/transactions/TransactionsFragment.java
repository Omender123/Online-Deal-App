...
import com.example.onlinedealapp.databinding.FragmentTransactionsOwnerBinding;
import com.example.onlinedealapp.ui.main.owner.adapter.TransactionsOwnerAdapter;
        ...
        btnDownload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (tvDateStart.getText().toString().isEmpty()) {
                    tvDateStart.setError("Can not be empty");
                }else if (tvDateEnd.getText().toString().isEmpty()) {
                    tvDateEnd.setError("Can not be empty");
                }else {
