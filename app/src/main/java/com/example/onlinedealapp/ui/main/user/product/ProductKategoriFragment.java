...
import com.example.onlinedealapp.databinding.FragmentProductCategoryBinding;
...
public class ProductKategoriFragment extends Fragment implements ProductAdapter.OnButtonClickListener {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        getAllProduct(getArguments().getString("id"));
    ...
    private void getAllProduct(String id) {
        ...
        userService.getProductByKategori(id).enqueue(new Callback<List<ProductModel>>() {
            @Override
            public void onResponse(Call<List<ProductModel>> call, Response<List<ProductModel>> response) {
                if (response.isSuccessful() && response.body().size() > 0) {
                    ...
                    productAdapter.setOnButtonClickListener(ProductKategoriFragment.this);
