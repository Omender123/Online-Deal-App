...
import com.example.onlinedealapp.databinding.FragmentDetailTransactionsBinding;
                ...
                btnUpload.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (etPath.getText().toString().isEmpty()) {
                            etPath.setError("You have not selected proof of payment");
                            etPath.requestFocus();
                        } else {

                            showProgressBar("Loading", "Evidence Validation...", true);
                            ...
                            userService.uploadBuktiTransfer(map, image).enqueue(new Callback<ResponseBody>() {
                                @Override
