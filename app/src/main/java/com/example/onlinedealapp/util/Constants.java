package com.example.onlinedealapp.util;

public class Constants {


    public static final String MAIN_END_POINT = "https://mobile-backend.000webhostapp.com/";
  //  public static final String URL_PRODUCT = MAIN_END_POINT + "uploads/";
    public static final String URL_PRODUCT = MAIN_END_POINT + "ortosec/assets/images/";
